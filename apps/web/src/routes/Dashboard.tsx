                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {selectedReportId === 'current' && (
                    <div className="relative flex items-center gap-2">
                      {showCloseConfirm ? (
                        <>
                          <span className="text-[10px] font-bold text-rose-600 bg-rose-50 border border-rose-200 px-2 py-1 rounded-sm animate-pulse">
                            Consolidar e arquivar concluídas?
                          </span>
                          <button
                            onClick={confirmCloseWeek}
                            disabled={isClosingWeek}
                            className="px-2.5 py-1 bg-emerald-600 hover:bg-emerald-700 text-white text-[10px] font-bold rounded-sm transition cursor-pointer"
                          >
                            Sim
                          </button>
                          <button
                            onClick={() => setShowCloseConfirm(false)}
                            className="px-2.5 py-1 bg-slate-200 hover:bg-slate-300 text-slate-700 text-[10px] font-bold rounded-sm transition cursor-pointer"
                          >
                            Não
                          </button>
                        </>
                        ...
                        <button
                          onClick={() => {
                            console.log('Fechar Semana clicked, showing confirm UI');
